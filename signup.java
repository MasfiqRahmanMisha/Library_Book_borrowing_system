...
public class signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setForeground(new java.awt.Color(161, 67, 68));
        jLabel4.setText("Role");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Your Role", "Branch Manager", "Admin" }));
        ...
        jLabel5.setForeground(new java.awt.Color(161, 67, 68));
        jLabel5.setText("Question");

        jLabel6.setForeground(new java.awt.Color(161, 67, 68));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "What is your mother name?", "What is your first pet name?", "What is your first school teacher name?" }));
        ...
        jButton2.setBackground(new java.awt.Color(161, 67, 68));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("D:\\NetBeansProjects\\com.mycompany_SE_OOP_jar_1.0-SNAPSHOT\\src\\main\\java\\com\\mycompany\\se_oop\\LBBS SideImage.png")); // NOI18N

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(161, 67, 68));
        jLabel11.setText("LiBorrow");

        jLabel12.setIcon(new javax.swing.ImageIcon("D:\\NetBeansProjects\\LibraryBookBorrowingSystem\\LB.png")); // NOI18N
        jLabel12.setText("jLabel6");

        jLabel13.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 20)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(161, 67, 68));
        jLabel13.setText("Welcome Back!");

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(166, 166, 166));
        jLabel14.setText("We are happy to see you again");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try {
            String sql = "insert into user(username,password,role,question,answer) value(?,?,?,?,?)";
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "User Registration Complete");
        } catch (Exception e) {
